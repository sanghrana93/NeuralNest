			...
			<div class="theme-inner-banner" style="background: #C7E2FF!important;">
				<div class="container">
					...
					<ul class="page-breadcrumb style-none d-flex justify-content-center">
						...
						<li class="current-page">John Sender</li>
					</ul>
				</div>
			...
			<?php if (!empty($ourTeamRecords)) { ?>
				<div class="team-details mt-110 mb-160 lg-mt-60 lg-mb-100">
					<div class="container">
						<div class="row">
						<?php 
						// Get the second record from the array
						$secondRecord = isset($ourTeamRecords[1]) ? $ourTeamRecords[1] : null;
						if ($secondRecord) { ?>
							<div class="col-xxl-10 col-lg-12 col-md-10 m-auto">
								<div class="main-bg d-lg-flex align-items-center">
									<div class="img-meta">
										<img src="<?= base_url(htmlspecialchars($secondRecord->member_photo)); ?>" alt="" class="w-100">
									</div>
									<div class="text-wrapper">
										<div class="name"><?= htmlspecialchars($secondRecord->member_name); ?></div>
										<div class="position"><?= htmlspecialchars($secondRecord->member_designation); ?></div>
										<h6>ABOUT ME</h6>
										<p class="pb-30"><?= htmlspecialchars($secondRecord->member_content); ?></p>
