<?php $this->load->view('layouts/link.php'); ?>
			...
			<div class="theme-inner-banner" style="background: #C7E2FF!important;">
				<div class="container">
					...
					<ul class="page-breadcrumb style-none d-flex justify-content-center">
						...
						<li class="current-page">Tyler Kreider</li>
					</ul>
				</div>
    ...
    <div class="team-details mt-110 mb-160 lg-mt-60 lg-mb-100">
        <div class="container">
            <div class="row">
            <?php 
            // Get the fourth record from the array
            $fourthRecord = isset($ourTeamRecords[3]) ? $ourTeamRecords[3] : null;
            if ($fourthRecord) { ?>
                <div class="col-xxl-10 col-lg-12 col-md-10 m-auto">
                    <div class="main-bg d-lg-flex align-items-center">
                        <div class="img-meta">
                            <img src="<?= base_url(htmlspecialchars($fourthRecord->member_photo)); ?>" alt="" class="w-100">
                        </div>
                        <div class="text-wrapper">
                            <div class="name"><?= htmlspecialchars($fourthRecord->member_name); ?></div>
                            <div class="position"><?= htmlspecialchars($fourthRecord->member_designation); ?></div>
                            <h6>ABOUT ME</h6>
                            <p class="pb-30"><?= htmlspecialchars($fourthRecord->member_content); ?></p>
