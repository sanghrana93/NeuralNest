...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <a href="<?php echo base_url().'addBlog'?>" target="_blank" rel="noopener noreferrer" class="btn btn-primary">Add Blog</a>
        <a href="<?php echo base_url().'blogList'?>" target="_blank" rel="noopener noreferrer" class="btn btn-primary">Blog List</a>
    </section>
</div>
